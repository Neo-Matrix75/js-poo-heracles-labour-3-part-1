...
const heracles = new Fighter('👨 Heracles', 20, 6, './images/heracles.svg', 5, 1);
...
const bird1 = new Fighter('Bird', 25, 12, './images/bird.svg',4,4);
const bird2 = new Fighter('Bird', 25, 12, './images/bird.svg',3,2);
const bird3 = new Fighter('Bird', 25, 12, './images/bird.svg',8,9);
